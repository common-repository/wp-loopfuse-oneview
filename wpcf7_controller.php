...
////////////SELECT DATA FROM THE TABLE FOR CONTACT FORM/////////////
	...
	$display = $wpdb->get_results($sql); 	
	$status = $display[0]->status;
	

		if($status == '1'){
			 
			$form = $wpcf7_contact_form->form_html_dynamic();
		}else{
